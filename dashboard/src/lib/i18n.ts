...
const EN = {
  ...
  // Predict
  predict_nav: 'Predict',
  predict_eyebrow: 'Predict the election',
  predict_title: 'Call the election',
  predict_subtitle:
    'Enter your predicted vote share for each party. Lock in your prediction, get a shareable histogram, and prove to everyone — after election day — that you called it.',
  predict_name_label: 'Your name',
  predict_name_placeholder: 'Enter your display name…',
  predict_party_pcts_title: 'Party vote share (%)',
  predict_remaining: (n: string) => `${n}% remaining`,
  predict_over_100: (n: string) => `${n}% over 100%`,
  predict_perfect: 'Adds up to 100% ✓',
  predict_submit: '🔒 Lock in my prediction',
  predict_submit_disabled: 'Must total 100%',
  predict_reset: 'Reset',
  predict_bonus_title: 'Bonus predictions',
  predict_bonus_parties: 'Parties entering parliament',
  predict_bonus_turnout: 'Voter turnout %',
  predict_over_under_title: 'Over / Under',
  predict_over: 'Over',
  predict_under: 'Under',
  predict_advanced_title: '🧪 Advanced mode',
  predict_advanced_toggle: 'Show advanced options',
  predict_advanced_district_title: 'District-level party percentages',
  predict_advanced_mps_title: 'Predict elected MPs by district',
  predict_advanced_mps_placeholder: 'Enter candidate name…',
  predict_scoring_eyebrow: 'How scoring works',
  predict_scoring_title: 'The scoring system',
  predict_scoring_body:
    'For each party, we take the absolute difference between your predicted percentage and the actual result. All differences are summed — the lower the total, the better your prediction.',
  predict_scoring_example_title: 'Example',
  predict_scoring_col_party: 'Party',
  predict_scoring_col_yours: 'Your prediction',
  predict_scoring_col_actual: 'Actual result',
  predict_scoring_col_diff: 'Difference',
  predict_scoring_total: 'Total score',
  predict_scoring_perfect: 'A perfect prediction scores 0.',
  predict_scoring_scale_excellent: 'Under 15 = excellent',
  predict_scoring_scale_good: 'Under 25 = good',
  predict_scoring_scale_ok: 'Under 40 = decent',
  predict_scoring_no_prizes: 'No prizes. Just endless Kudos. 🏆',
  predict_leaderboard_title: 'Leaderboard',
  predict_leaderboard_coming: '🏁 Coming after election day — May 24, 2026',
  predict_leaderboard_rank: '#',
  predict_leaderboard_name: 'Name',
  predict_leaderboard_score: 'Score',
  predict_leaderboard_date: 'Submitted',
  predict_share_title: 'Share your prediction',
  predict_share_x: 'Post on X',
  predict_share_fb: 'Share on Facebook',
  ...
  predict_my_predictions: 'My predictions',
  predict_no_predictions: 'No predictions yet. Fill in the form above!',
  predict_delete: 'Delete',
  predict_view: 'View',
...
const GR: typeof EN = {
  ...
  predict_nav: 'Πρόβλεψη',
  predict_eyebrow: 'Πρόβλεψη εκλογών',
  predict_title: 'Πες το αποτέλεσμα',
  predict_subtitle:
    'Συμπλήρωσε το ποσοστό κάθε κόμματος. Κλείδωσε την πρόβλεψή σου, μοιράσου το ιστόγραμμα, και απόδειξε σε όλους — μετά τις εκλογές — ότι το είχες πει.',
  predict_name_label: 'Το όνομά σου',
  predict_name_placeholder: 'Γράψε το εμφανιζόμενο όνομά σου…',
  predict_party_pcts_title: 'Ποσοστό κάθε κόμματος (%)',
  predict_remaining: (n: string) => `${n}% απομένει`,
  predict_over_100: (n: string) => `${n}% πάνω από 100%`,
  predict_perfect: 'Αθροίζει σε 100% ✓',
  predict_submit: '🔒 Κλείδωσε την πρόβλεψη',
  predict_submit_disabled: 'Πρέπει να αθροίζει 100%',
  predict_reset: 'Επαναφορά',
  predict_bonus_title: 'Μπόνους προβλέψεις',
  predict_bonus_parties: 'Κόμματα που μπαίνουν στη Βουλή',
  predict_bonus_turnout: 'Ποσοστό συμμετοχής %',
  predict_over_under_title: 'Πάνω / Κάτω',
  predict_over: 'Πάνω',
  predict_under: 'Κάτω',
  predict_advanced_title: '🧪 Προχωρημένη λειτουργία',
  predict_advanced_toggle: 'Εμφάνιση προχωρημένων επιλογών',
  predict_advanced_district_title: 'Ποσοστά ανά επαρχία',
  predict_advanced_mps_title: 'Πρόβλεψη εκλεγμένων βουλευτών ανά επαρχία',
  predict_advanced_mps_placeholder: 'Γράψε όνομα υποψηφίου…',
  predict_scoring_eyebrow: 'Πώς γίνεται η βαθμολόγηση',
  predict_scoring_title: 'Το σύστημα βαθμολόγησης',
  predict_scoring_body:
    'Για κάθε κόμμα, παίρνουμε την απόλυτη διαφορά μεταξύ του ποσοστού που πρόβλεψες και του πραγματικού αποτελέσματος. Όλες οι διαφορές αθροίζονται — όσο χαμηλότερο το σύνολο, τόσο καλύτερη η πρόβλεψη.',
  predict_scoring_example_title: 'Παράδειγμα',
  predict_scoring_col_party: 'Κόμμα',
  predict_scoring_col_yours: 'Η πρόβλεψή σου',
  predict_scoring_col_actual: 'Πραγματικό αποτέλεσμα',
  predict_scoring_col_diff: 'Διαφορά',
  predict_scoring_total: 'Συνολική βαθμολογία',
  predict_scoring_perfect: 'Μια τέλεια πρόβλεψη βαθμολογείται με 0.',
  predict_scoring_scale_excellent: 'Κάτω από 15 = εξαιρετικό',
  predict_scoring_scale_good: 'Κάτω από 25 = καλό',
  predict_scoring_scale_ok: 'Κάτω από 40 = αξιοπρεπές',
  predict_scoring_no_prizes: 'Κανένα βραβείο. Μόνο ατελείωτα Kudos. 🏆',
  predict_leaderboard_title: 'Κατάταξη',
  predict_leaderboard_coming: '🏁 Ετοιμάζεται μετά τις εκλογές — 24 Μαΐου 2026',
  predict_leaderboard_rank: '#',
  predict_leaderboard_name: 'Όνομα',
  predict_leaderboard_score: 'Σκορ',
  predict_leaderboard_date: 'Υποβλήθηκε',
  predict_share_title: 'Μοιράσου την πρόβλεψή σου',
  predict_share_x: 'Ανάρτηση στο X',
  predict_share_fb: 'Κοινοποίηση στο Facebook',
  ...
  predict_card_watermark: 'polismetrics.com',
  predict_my_predictions: 'Οι προβλέψεις μου',
  predict_no_predictions: 'Δεν υπάρχουν ακόμα προβλέψεις. Συμπλήρωσε τη φόρμα!',
  predict_delete: 'Διαγραφή',
  predict_view: 'Προβολή',
