...
export function Highlights({ data }: { data: Dataset }) {
  ...
  return (
    <div>
      ...
      <DataSource
        summary="Each highlight bullet is generated by an LLM summarising the candidate's bio. The 'source' link on every card points to the underlying bio source — that is the authoritative document, not the LLM-generated text."
